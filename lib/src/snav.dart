...
class SNav extends StatefulWidget {
  const SNav({
    Key? key,
    required this.tabs,
  ...
  @override
  _SNavState createState() => _SNavState();
}

class _SNavState extends State<SNav> {
  ...
  @override
  void didUpdateWidget(SNav oldWidget) {
